      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <span className="font-semibold text-xl tracking-tight text-gray-900 mb-4 block">SubTrack</span>
            <p className="text-gray-500 text-sm leading-relaxed">
              Global subscription management for the modern digital life.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase mb-4">Settings</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                 <Globe className="w-4 h-4 text-gray-400" />
                 <select className="bg-transparent text-sm text-gray-600 border-none focus:ring-0 cursor-pointer hover:text-gray-900 pr-8">
                   {LANGUAGES.map(lang => (
