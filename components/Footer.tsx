        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center relative z-10 gap-4">
          ...
          <div className="flex flex-col items-end gap-2">
             <div className="flex space-x-8 rtl:space-x-reverse mt-6 md:mt-0">
                ...
                <a href="https://github.com/kutluhangil/SubSense" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 transform hover:scale-110 transition-all duration-300" aria-label="SubSense GitHub">
             ...
             <p className="text-[10px] text-gray-300 font-medium">Built with <strong className="text-gray-500">Firebase</strong> & <strong className="text-blue-500">Gemini</strong></p>
          </div>
        </div>
      </div>
