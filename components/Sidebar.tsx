...
const Sidebar = ({
  ...
  return (
    <>
      <div className="hidden md:flex flex-col w-64 bg-sidebar border-r border-subtle h-full min-h-0 overflow-y-auto overscroll-contain transition-colors duration-300">
        {/* Logo Area */}
        <div
          className="h-20 flex items-center px-6 border-b border-subtle cursor-pointer"
        ...
        <div className="flex-1 py-8 px-4 space-y-1 overflow-y-auto">
          <p className="px-4 text-xs font-semibold text-muted uppercase tracking-wider mb-4">
            {t("sidebar.menu")}
          </p>
          {navItems.map((item) => (
            <button
        ...
        <div className="p-4 border-t border-subtle">
          ...
          >
            <LogOut
              size={20}
              className="text-muted group-hover:text-red-500 dark:group-hover:text-red-400"
            />
