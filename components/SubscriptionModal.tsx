                 ...
                 <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <div className="space-y-4">
                       ...
                       <button 
                         ...
                         className="w-full bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-3 rounded-xl font-bold transition-all shadow-lg shadow-gray-900/10 dark:shadow-black/20 mt-2 border border-transparent active:scale-95"
                         style={{ 
              ...
              <div className="lg:col-span-5 space-y-6">
                 ...
                 <div className="space-y-3">
                    <button 
                      ...
                      className="w-full py-3 rounded-xl font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center justify-center gap-2 border border-transparent hover:border-red-100 dark:hover:border-red-900/30"
                    >
