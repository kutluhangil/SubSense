...
const BetaBadge = () => {
    return (
        <div className="relative group inline-flex items-center ml-2 cursor-help z-50">
            {/* Animated Badge */}
            <motion.div
            ...
            {/* Tooltip */}
            <div className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-64 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-300 transform group-hover:translate-y-0 translate-y-2 z-[100]">
                <div className="relative bg-gray-900/95 dark:bg-white/95 backdrop-blur-xl p-4 rounded-xl shadow-2xl border border-gray-700 dark:border-gray-200 text-left">
                    ...
                    <p className="text-gray-300 dark:text-gray-700 text-xs leading-relaxed font-medium">
                        ...
                        <br /><br />
                        <span className="text-white dark:text-gray-900 font-bold">If you want polished perfection, come back later. If you want the future, welcome.</span>
                    </p>
