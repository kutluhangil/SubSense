...
const HINTS = [
  "Track all your subscriptions in one clean dashboard.",
  "Compare Netflix, Spotify, or Adobe prices globally.",
  "Get notified before your next payment is due.",
  "See how much you spend monthly — automatically calculated.",
  "Invite friends and see shared subscriptions.",
  "Switch currencies and languages anytime.",
  "Monitor price changes in real time with smart alerts.",
  "AI helps you optimize your recurring expenses.",
  "Keep your data secure with built-in privacy controls.",
  "Light or dark mode — choose your style."
];
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden p-6 rounded-2xl bg-white backdrop-blur-sm border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-32 flex flex-col justify-center">
        ...
        {/* Decorative Side Bar */}
        <div className="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-[#1B3A6D] to-[#3ABEFF] transition-all duration-300"></div>
        ...
        <div className="flex items-start gap-4 px-2">
          ...
          <div className="flex-shrink-0 self-center opacity-0 group-hover/card:opacity-100 transition-opacity duration-300 -mr-2">
