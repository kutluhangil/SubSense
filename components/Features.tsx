    ...
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="relative pt-24 pb-20 sm:pt-32 sm:pb-24 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-6 max-w-4xl">
            {t('features.main.hero_title')}
          </h1>

          <p className="mt-4 text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            ...
            <button 
              onClick={onOpenDemo}
              className="w-full sm:w-auto px-8 py-3.5 text-base font-medium text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-all duration-200"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-gray-700 p-8 rounded-2xl border border-gray-100 dark:border-gray-600 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
                <div className="w-12 h-12 bg-gray-50 dark:bg-gray-600 rounded-xl flex items-center justify-center mb-6 group-hover:bg-gray-900 dark:group-hover:bg-white transition-colors duration-300">
                  <feature.icon size={24} className="text-gray-900 dark:text-white group-hover:text-white dark:group-hover:text-gray-900 transition-colors duration-300" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            <div className="bg-gray-900 rounded-xl p-2 shadow-2xl ring-1 ring-gray-900/10 cursor-pointer" onClick={onOpenDemo}>
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 aspect-[16/10] relative flex flex-col group">
                 {/* Fake Browser Header */}
                 <div className="h-8 bg-white dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 flex items-center px-4 gap-2">
                    <div className="w-3 h-3 rounded-full bg-red-400"></div>
                    <div className="w-3 h-3 rounded-full bg-yellow-400"></div>
                    <div className="w-3 h-3 rounded-full bg-green-400"></div>
                 </div>
                 {/* Fake UI Content */}
                 <div className="flex-1 p-8 grid grid-cols-12 gap-6 bg-gray-50 dark:bg-gray-800 transition-transform duration-500 group-hover:scale-[1.02]">
                    {/* Sidebar */}
                    <div className="col-span-2 bg-white dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600 hidden md:block"></div>
                    {/* Main */}
                    <div className="col-span-12 md:col-span-10 space-y-6">
                       <div className="h-32 grid grid-cols-3 gap-6">
                          <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600"></div>
                          <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600"></div>
                          <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600"></div>
                       </div>
                       <div className="h-64 bg-white dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="absolute top-0 right-0 w-3/4 h-3/4 bg-gray-100 dark:bg-gray-700 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob"></div>
              <div className="relative bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 max-w-sm mx-auto transform rotate-2 hover:rotate-0 transition-transform duration-500">
                 <div className="flex items-center space-x-4 mb-6">
                    <div className="w-12 h-12 bg-gray-200 dark:bg-gray-600 rounded-full"></div>
                    <div>
                       <div className="h-4 w-32 bg-gray-900 dark:bg-gray-300 rounded mb-2"></div>
                       <div className="h-3 w-20 bg-gray-200 dark:bg-gray-600 rounded"></div>
                    </div>
                 </div>
                 <div className="flex space-x-2 mb-4">
                    <div className="w-10 h-10 bg-gray-50 dark:bg-gray-700 rounded-full flex items-center justify-center text-xs font-bold text-gray-400 border border-gray-100 dark:border-gray-600">NF</div>
                    <div className="w-10 h-10 bg-gray-50 dark:bg-gray-700 rounded-full flex items-center justify-center text-xs font-bold text-gray-400 border border-gray-100 dark:border-gray-600">SP</div>
                    <div className="w-10 h-10 bg-gray-50 dark:bg-gray-700 rounded-full flex items-center justify-center text-xs font-bold text-gray-400 border border-gray-100 dark:border-gray-600">YT</div>
                 </div>
      ...
      <div className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={() => onOpenAuth('signup')}
              className="w-full sm:w-auto px-8 py-4 text-lg font-semibold text-white bg-gray-900 dark:bg-white dark:text-gray-900 rounded-full hover:bg-gray-800 dark:hover:bg-gray-100 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1"
            >
              {t('hero.start_tracking_free')}
            </button>
            <button
               onClick={() => onOpenAuth('signup')}
               className="w-full sm:w-auto px-8 py-4 text-lg font-medium text-gray-900 dark:text-white bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 transition-all"
            >
              {t('nav.signup')} Now
            </button>
          </div>
